...
namespace Assembler.Pseudoinstructions.StorePseudoinstructions {
    ...
    /// AddwI $rDest, #value16
    /// </summary>
    class SbramoiPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.SbramoI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            if (DoesDestRegisterViolateDefaultRestrictions(rValueToken)) {
                ...
                yield return InstructionEncoder.Encode(McInstructionType.Sbramo, rValue, rAddress, Regs.Ass);
            }
        }
    }
}
