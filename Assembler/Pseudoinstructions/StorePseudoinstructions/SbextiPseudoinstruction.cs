...
namespace Assembler.Pseudoinstructions.StorePseudoinstructions {
    ...
    /// AddwI $rDest, #value16
    /// </summary>
    class SbextiPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.SbextI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Sbext, Regs.Zero, rA, Regs.Ass);
        }
    }
}
