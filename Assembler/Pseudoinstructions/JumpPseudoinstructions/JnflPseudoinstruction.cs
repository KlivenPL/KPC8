...
namespace Assembler.Pseudoinstructions.JumpPseudoinstructions {
    ...
    /// Jl #label
    /// </summary>
    class JnflPseudoinstruction : PseudoinstructionBase {
        private const int SizeInBytes = 3 * 2;
        public override PseudoinstructionType Type => PseudoinstructionType.Jnfl;
        ...
        private IEnumerable<IEnumerable<BitArray>> ParseLabelInner(ushort labelAddress) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Jnf, Regs.Zero, Regs.Zero, Regs.Ass);
        }
    }
}
