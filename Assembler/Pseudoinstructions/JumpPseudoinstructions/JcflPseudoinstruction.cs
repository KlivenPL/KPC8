...
namespace Assembler.Pseudoinstructions.JumpPseudoinstructions {
    ...
    /// Jl #label
    /// </summary>
    class JcflPseudoinstruction : PseudoinstructionBase {
        private const int SizeInBytes = 3 * 2;
        public override PseudoinstructionType Type => PseudoinstructionType.Jcfl;
        ...
        private IEnumerable<IEnumerable<BitArray>> ParseLabelInner(ushort labelAddress) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Jcf, Regs.Zero, Regs.Zero, Regs.Ass);
        }
    }
}
