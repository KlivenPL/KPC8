...
namespace Assembler.Pseudoinstructions.LogicPseudoinstructions {
    ...
    /// Ori $rA, #value8
    /// </summary>
    class OriPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.OrI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            if (DoesDestRegisterViolateDefaultRestrictions(rAToken)) {
                ...
                yield return InstructionEncoder.Encode(McInstructionType.Or, rA, rA, Regs.Ass);
            }
        }
    }
}
