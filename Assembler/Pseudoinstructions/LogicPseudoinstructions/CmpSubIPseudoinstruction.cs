...
namespace Assembler.Pseudoinstructions.LogicPseudoinstructions {
    ...
    /// Ori $rA, #value8
    /// </summary>
    class CmpSubIPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.CmpSubI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Sub, Regs.Ass, rA, Regs.Ass);
        }
    }
}
