...
namespace Assembler.Pseudoinstructions.LogicPseudoinstructions {
    ...
    /// Ori $rA, #value16
    /// </summary>
    class OrwPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.Orw;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Or, Regs.Ass, rDest, Regs.Ass);
            yield return InstructionEncoder.Encode(McInstructionType.Setloh, Regs.Zero, rDest, Regs.Ass);
            yield return InstructionEncoder.Encode(McInstructionType.Or, Regs.Ass, rA, rB);
