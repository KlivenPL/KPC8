...
namespace Assembler.Pseudoinstructions.LoadPseudoinstructions {
    ...
    /// AddwI $rDest, #value16
    /// </summary>
    class LwramiPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.LwramI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Lwram, Regs.Zero, rA, Regs.Ass);
        }
    }
}
