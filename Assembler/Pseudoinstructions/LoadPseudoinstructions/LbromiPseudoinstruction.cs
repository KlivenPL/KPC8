...
namespace Assembler.Pseudoinstructions.LoadPseudoinstructions {
    ...
    /// AddwI $rDest, #value16
    /// </summary>
    class LbromiPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.LbromI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Lbrom, Regs.Zero, rA, Regs.Ass);
        }
    }
}
