...
namespace Assembler.Pseudoinstructions.LoadPseudoinstructions {
    ...
    /// AddwI $rDest, #value16
    /// </summary>
    class LwromiPseudoinstruction : PseudoinstructionBase {
        public override PseudoinstructionType Type => PseudoinstructionType.LwromI;
        ...
        protected override IEnumerable<IEnumerable<BitArray>> ParseInner(TokenReader reader) {
            ...
            yield return InstructionEncoder.Encode(McInstructionType.Lwrom, Regs.Zero, rA, Regs.Ass);
        }
    }
}
