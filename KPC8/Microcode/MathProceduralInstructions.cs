...
namespace KPC8.Microcode {
    public static class MathProceduralInstructions {
        ...
        [ProceduralInstruction(McInstructionType.AddC)]
        public static IEnumerable<Cs> AddC() {
        ...
        [ProceduralInstruction(McInstructionType.NegC)]
        public static IEnumerable<Cs> NegC() {
