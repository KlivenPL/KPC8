namespace LightweightEmulator.Kpc {
    internal class LwInstruction {
        public LwInstruction(byte instructionHigh, byte instructionLow) {
            Type = (LwInstructionType)(ushort)(instructionHigh >> 2);
        ...
        public LwInstructionType Type { get; }
